#!/usr/bin/env python
# coding: utf-8
# helper functions for the regression model
...
def performance_table_single(result_dict):
    ...
    df['MAPE'] = result_dict['NORTH_AMERICA']['MAPE']
    df['RMSE'] = result_dict['NORTH_AMERICA']['RMSE']
    df['NRMSE'] = result_dict['NORTH_AMERICA']['NRMSE']
    df['ND'] = result_dict['NORTH_AMERICA']['ND']
    df['Country'] = 'ENTIRE'
...
#Augmented Out of Sample; functions to run each model using augmented out of sample training 
